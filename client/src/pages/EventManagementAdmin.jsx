    ...
    <>
        {isEventDate ? (
          <Button
            ...
            a href="#casematter"
            onClick={() => {
              handleViewClick(events.event_id);
            }}
          >
            {day}
          </Button>
    ...
    <div>
      ...
      <div className="wrapper">
        ...
        <List
          ...
          renderItem={(item) => (
            <List.Item>
              <a href="#casematter" onClick={() => handleViewClick(item.event_id)}>
