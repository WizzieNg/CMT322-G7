    ...
    <div className="app">
      <BrowserRouter>
        ...
        <Route path="/Signup" element={<SignUp />} />
          ...
          <Route path="/ViewEventStaff/:eventId" element={<ViewEventStaff />} />
          <Route path="/ViewEventAdmin/:eventId" element={<ViewEventAdmin />} />
          <Route path="/ViewEventClient/:eventId" element={<ViewEventClient />} />
